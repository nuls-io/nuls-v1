package io.nuls.core.utils.queue.fqueue.internal;
...
import io.nuls.core.utils.queue.util.MappedBufferCleanUtil;
...
public class Entity {
    ...
    public Entity(String path, int fileNumber, long fileLimitLength, io.nuls.core.utils.queue.fqueue.internal.Index db)
