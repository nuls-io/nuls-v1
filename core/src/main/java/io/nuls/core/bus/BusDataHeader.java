 ...
 * @date 2017/11/7
 */
public class BusDataHeader extends BaseNulsData {
    ...
    public BusDataHeader(short moduleId, short eventType, byte[] extend) {
    ...
    public BusDataHeader(short moduleId, short eventType) {
        this(moduleId, eventType, null);
    }

    public BusDataHeader(short eventType) {
        this((short) (0), eventType);
    }

    public BusDataHeader() {
