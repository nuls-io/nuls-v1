...
public class ScriptOpCodes {
    ...
    private static final Map<String, Integer> opCodeNameMap = new HashMap<String, Integer>();
    ...
    static {
        ...
        opCodeNameMap.put("PUSHDATA4", OP_PUSHDATA4);
        opCodeNameMap.put("1NEGATE", OP_1NEGATE);
        opCodeNameMap.put("RESERVED", OP_RESERVED);
        opCodeNameMap.put("1", OP_1);
        opCodeNameMap.put("2", OP_2);
        opCodeNameMap.put("3", OP_3);
        opCodeNameMap.put("4", OP_4);
        opCodeNameMap.put("5", OP_5);
        opCodeNameMap.put("6", OP_6);
        opCodeNameMap.put("7", OP_7);
        opCodeNameMap.put("8", OP_8);
        opCodeNameMap.put("9", OP_9);
        opCodeNameMap.put("10", OP_10);
        opCodeNameMap.put("11", OP_11);
        opCodeNameMap.put("12", OP_12);
        opCodeNameMap.put("13", OP_13);
        opCodeNameMap.put("14", OP_14);
        opCodeNameMap.put("15", OP_15);
        opCodeNameMap.put("16", OP_16);
        opCodeNameMap.put("NOP", OP_NOP);
        opCodeNameMap.put("VER", OP_VER);
        opCodeNameMap.put("IF", OP_IF);
        opCodeNameMap.put("NOTIF", OP_NOTIF);
        opCodeNameMap.put("VERIF", OP_VERIF);
        opCodeNameMap.put("VERNOTIF", OP_VERNOTIF);
        opCodeNameMap.put("ELSE", OP_ELSE);
        opCodeNameMap.put("ENDIF", OP_ENDIF);
        opCodeNameMap.put("VERIFY", OP_VERIFY);
        opCodeNameMap.put("RETURN", OP_RETURN);
        opCodeNameMap.put("TOALTSTACK", OP_TOALTSTACK);
        opCodeNameMap.put("FROMALTSTACK", OP_FROMALTSTACK);
        opCodeNameMap.put("2DROP", OP_2DROP);
        opCodeNameMap.put("2DUP", OP_2DUP);
        opCodeNameMap.put("3DUP", OP_3DUP);
        opCodeNameMap.put("2OVER", OP_2OVER);
        opCodeNameMap.put("2ROT", OP_2ROT);
        opCodeNameMap.put("2SWAP", OP_2SWAP);
        opCodeNameMap.put("IFDUP", OP_IFDUP);
        opCodeNameMap.put("DEPTH", OP_DEPTH);
        opCodeNameMap.put("DROP", OP_DROP);
        opCodeNameMap.put("DUP", OP_DUP);
        opCodeNameMap.put("NIP", OP_NIP);
        opCodeNameMap.put("OVER", OP_OVER);
        opCodeNameMap.put("PICK", OP_PICK);
        opCodeNameMap.put("ROLL", OP_ROLL);
        opCodeNameMap.put("ROT", OP_ROT);
        opCodeNameMap.put("SWAP", OP_SWAP);
        opCodeNameMap.put("TUCK", OP_TUCK);
        opCodeNameMap.put("CAT", OP_CAT);
        opCodeNameMap.put("SUBSTR", OP_SUBSTR);
        opCodeNameMap.put("LEFT", OP_LEFT);
        opCodeNameMap.put("RIGHT", OP_RIGHT);
        opCodeNameMap.put("SIZE", OP_SIZE);
        opCodeNameMap.put("INVERT", OP_INVERT);
        opCodeNameMap.put("AND", OP_AND);
        opCodeNameMap.put("OR", OP_OR);
        opCodeNameMap.put("XOR", OP_XOR);
        opCodeNameMap.put("EQUAL", OP_EQUAL);
        opCodeNameMap.put("EQUALVERIFY", OP_EQUALVERIFY);
        opCodeNameMap.put("RESERVED1", OP_RESERVED1);
        opCodeNameMap.put("RESERVED2", OP_RESERVED2);
        opCodeNameMap.put("1ADD", OP_1ADD);
        opCodeNameMap.put("1SUB", OP_1SUB);
        opCodeNameMap.put("2MUL", OP_2MUL);
        opCodeNameMap.put("2DIV", OP_2DIV);
        opCodeNameMap.put("NEGATE", OP_NEGATE);
        opCodeNameMap.put("ABS", OP_ABS);
        opCodeNameMap.put("NOT", OP_NOT);
        opCodeNameMap.put("0NOTEQUAL", OP_0NOTEQUAL);
        opCodeNameMap.put("ADD", OP_ADD);
        opCodeNameMap.put("SUB", OP_SUB);
        opCodeNameMap.put("MUL", OP_MUL);
        opCodeNameMap.put("DIV", OP_DIV);
        opCodeNameMap.put("MOD", OP_MOD);
        opCodeNameMap.put("LSHIFT", OP_LSHIFT);
        opCodeNameMap.put("RSHIFT", OP_RSHIFT);
        opCodeNameMap.put("BOOLAND", OP_BOOLAND);
        opCodeNameMap.put("BOOLOR", OP_BOOLOR);
        opCodeNameMap.put("NUMEQUAL", OP_NUMEQUAL);
        opCodeNameMap.put("NUMEQUALVERIFY", OP_NUMEQUALVERIFY);
        opCodeNameMap.put("NUMNOTEQUAL", OP_NUMNOTEQUAL);
        opCodeNameMap.put("LESSTHAN", OP_LESSTHAN);
        opCodeNameMap.put("GREATERTHAN", OP_GREATERTHAN);
        opCodeNameMap.put("LESSTHANOREQUAL", OP_LESSTHANOREQUAL);
        opCodeNameMap.put("GREATERTHANOREQUAL", OP_GREATERTHANOREQUAL);
        opCodeNameMap.put("MIN", OP_MIN);
        opCodeNameMap.put("MAX", OP_MAX);
        opCodeNameMap.put("WITHIN", OP_WITHIN);
        opCodeNameMap.put("RIPEMD160", OP_RIPEMD160);
        opCodeNameMap.put("SHA1", OP_SHA1);
        opCodeNameMap.put("SHA256", OP_SHA256);
        opCodeNameMap.put("HASH160", OP_HASH160);
        opCodeNameMap.put("HASH256", OP_HASH256);
        opCodeNameMap.put("CODESEPARATOR", OP_CODESEPARATOR);
        opCodeNameMap.put("CHECKSIG", OP_CHECKSIG);
        opCodeNameMap.put("CHECKSIGVERIFY", OP_CHECKSIGVERIFY);
        opCodeNameMap.put("CHECKMULTISIG", OP_CHECKMULTISIG);
        opCodeNameMap.put("CHECKMULTISIGVERIFY", OP_CHECKMULTISIGVERIFY);
        opCodeNameMap.put("NOP1", OP_NOP1);
        opCodeNameMap.put("CHECKLOCKTIMEVERIFY", OP_CHECKLOCKTIMEVERIFY);
        opCodeNameMap.put("NOP2", OP_NOP2);
        opCodeNameMap.put("NOP3", OP_NOP3);
        opCodeNameMap.put("NOP4", OP_NOP4);
        opCodeNameMap.put("NOP5", OP_NOP5);
        opCodeNameMap.put("NOP6", OP_NOP6);
        opCodeNameMap.put("NOP7", OP_NOP7);
