...
public class SM2Utils 
{
	...
	public static byte[] sign(byte[] userId, byte[] privateKey, byte[] sourceData) throws IOException
	{
		...
		System.out.println("��Բ���ߵ�X: " + userKey.getX().toBigInteger().toString(16));
		System.out.println("��Բ���ߵ�Y: " + userKey.getY().toBigInteger().toString(16));
		System.out.println("");
		
		SM3Digest sm3 = new SM3Digest();
		byte[] z = sm2.sm2GetZ(userId, userKey);
		System.out.println("SM3ժҪZ: " + Util.getHexString(z));
	    System.out.println("");
	    ...
	    System.out.println("SM3ժҪֵ: " + Util.getHexString(md));
	    System.out.println("");
