...
public class SM2 
{
	...
	public void sm2Sign(byte[] md, BigInteger userD, ECPoint userKey, SM2Result sm2Result) 
	{
		...
		do 
		{
			do 
			{
		        ...
		        System.out.println("�������ߵ�X1: " + kp.getX().toBigInteger().toString(16));
				System.out.println("�������ߵ�Y1: " + kp.getY().toBigInteger().toString(16));
				System.out.println("");
	...
	public void sm2Verify(byte md[], ECPoint userKey, BigInteger r, BigInteger s, SM2Result sm2Result)
    {
        ...
        else
        {
            ...
            System.out.println("�������ߵ�X0: " + x1y1.getX().toBigInteger().toString(16));
			System.out.println("�������ߵ�Y0: " + x1y1.getY().toBigInteger().toString(16));
			System.out.println("");
			
            x1y1 = x1y1.add(userKey.multiply(t));
            System.out.println("�������ߵ�X1: " + x1y1.getX().toBigInteger().toString(16));
			System.out.println("�������ߵ�Y1: " + x1y1.getY().toBigInteger().toString(16));
			System.out.println("");
