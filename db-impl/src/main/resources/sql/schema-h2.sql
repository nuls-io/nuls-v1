...
CREATE TABLE IF NOT EXISTS `account` (
  ...
  `pub_key` varbinary(102400) DEFAULT NULL,
  `create_time` bigint(11) NOT NULL,
  `create_height` bigint(11) NOT NULL,
  `tx_hash` varbinary(102400) DEFAULT NULL,
  `alias` varchar(100) DEFAULT NULL,
  `version` int(11) NOT NULL,
  `pri_key` varchar(100) DEFAULT NULL,
  `pri_seed` varbinary(102400) DEFAULT NULL,
  `EXTEND` varbinary(102400) DEFAULT NULL,
  PRIMARY KEY (`id`)
);
...
CREATE TABLE IF NOT EXISTS `block` (
  ...
  `create_time` bigint(11) NOT NULL,
  `period_start_time` bigint(11) NOT NULL,
  `time_period` int(5) NOT NULL,
  `consensus_address` varchar(40) NOT NULL,
  `varsion` int(5) NOT NULL,
  `txCount` int(5) NOT NULL,
  `txs` varbinary(102400) NOT NULL,
  `sign` varbinary(102400) NOT NULL,
  PRIMARY KEY (`hash`)
);
...
CREATE TABLE IF NOT EXISTS `sub_chain` (
  ...
  `g_block` varbinary(102400) NOT NULL,
  `g_block_hash` varchar(70) NOT NULL,
  `g_merkle_hash` varchar(70) NOT NULL,
  `g_block_header` varbinary(102400) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `transaction` (
  ...
  `txData` varbinary(102400) NOT NULL,
  `sign` varbinary(102400) NOT NULL,
  `extend` varbinary(102400) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `utxo_input` (
  ...
  `script` varbinary(102400) NOT NULL,
  PRIMARY KEY (`hash`)
);
