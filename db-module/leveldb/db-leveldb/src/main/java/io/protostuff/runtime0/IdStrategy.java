//package io.protostuff.runtime0;
//
...
//                Object value = ObjectSchema.readObjectFrom(input, this, owner, IdStrategy.this);
//                final boolean isNull = value instanceof Object[][][][][][][][][];
//                ((Collection<Object>) owner).add(isNull ? null : value);
//
//                //TODO pierre
...
//                //TODO pierre
//                output.writeObject(1, value != null ? value : NULL, DYNAMIC_VALUE_SCHEMA, true);
//                //if (value != null)
//                //{
//                //    output.writeObject(1, value, DYNAMIC_VALUE_SCHEMA, true);
//                //}
