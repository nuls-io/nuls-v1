...
public class NulsVersionHandler extends DefaultHandler {
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
        ...
        if(PROTOCOL.equals(qName)) {
            ...
            protocolContainer.setVersion(Integer.parseInt(version));
            protocolContainer.setPercent(Integer.parseInt(percent));
            protocolContainer.setDelay(Integer.parseInt(delay));
            ...
            extendTS = StringUtils.isBlank(extend) ? null : Integer.parseInt(extend);

            String block = attributes.getValue(PROTOCOL_BLOCK);
            if(StringUtils.isNotBlank(block)) {
                Class blockClass = null;
                try {
                    blockClass = Class.forName(block);
        ...
        if(PROTOCOL_TX_DISCARD.equals(qName)){
            ...
            Class txCLass = NulsVersionManager.getTxProtocol(discard);
            Transaction tx = null;
            try {
