 ...
 * @date: 2018/4/24
 */
public class MicroKernelBootstrap1Test extends BaseModuleBootstrap {

    private static final MicroKernelBootstrap1Test INSTANCE = new MicroKernelBootstrap1Test();

    private MicroKernelBootstrap1Test() {
        super(NulsConstant.MODULE_ID_MICROKERNEL);
    }

    public static MicroKernelBootstrap1Test getInstance() {
        return INSTANCE;
    }
    @Override
    public void init() {
